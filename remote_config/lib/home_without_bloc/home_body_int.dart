...
class HomeBodyInt extends StatefulWidget {
  @override
  _HomeBodyIntState createState() => _HomeBodyIntState();
}

class _HomeBodyIntState extends State<HomeBodyInt> {
  ...
  Future<RemoteConfig> initializeRemoteConfig() async {
    ...
    final defaultValues = <String, dynamic>{"ExampleInt": 2};
      ...
      body: Container(
        child: FutureBuilder<RemoteConfig>(
          ...
          builder: (BuildContext context, AsyncSnapshot<RemoteConfig> snapshot) {
            return Center(
              child: snapshot.hasData ? Text(snapshot.data.getInt("ExampleInt").toString()) : CircularProgressIndicator(),
            );
          },
        ),
      ),
